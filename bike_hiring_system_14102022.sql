...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2022 at 01:07 PM
...
(318, 'E-Bike step through_01', 57, 2, 25, 0, 'Size: Medium\r\nColour: Blue'),
(319, 'E-Bike step through_02', 57, 2, 25, 1, 'Size: Medium Colour: Red'),
(320, 'E-Bike step over_01', 58, 2, 25, 1, 'Size: Medium Colour: Green'),
(321, 'E-Bike step over_02', 58, 2, 25, 1, 'Size: Medium Colour: Black'),
(322, 'Standard Step Through Bike_01', 59, 2, 25, 1, 'Size: Medium Colour: Blue'),
(323, 'Standard Step Through Bike_02', 59, 2, 25, 1, 'Size: Medium Colour: Red'),
(324, 'Standard Step Over Bike_01', 60, 2, 25, 1, 'Size: Medium Colour: Green'),
(325, 'Standard Step Over Bike_02', 60, 2, 25, 1, 'Size: Medium Colour: Black'),
(326, 'Mountain Bike - Hard Tail_01', 61, 2, 25, 1, 'Size: Medium Colour: White'),
(327, 'Mountain Bike - Hard Tail_02', 61, 2, 25, 1, 'Size: Medium Colour: White');
...
(57, 'E-Bike step through', '1', 'A electronic step through bike with a chassis that allows you to mount the bike with ease by stepping through the bike'),
(58, 'E-Bike step over', '2', 'A electronic step over bike with a chassis that is the same as a standard bike, where you mount bike climbing over the bike'),
(59, 'Standard step through bike', '3', 'A standard step through bike with a chassis that allows you to mount the bike with ease by stepping through the bike. The bike is used traditionally like a normal bike that you can pedal'),
(60, 'Standard step over bike', '4', 'A standard step over bike with a chassis that is similar to a regular bike. The bike is used traditionally like a normal bike that you can pedal'),
(61, 'Mountain Bike - Hard Tail', '5', 'A mountain bike that can be used for the roughest trails and off track');
...
(35, 'CU-ElizabethRules33', '2022-10-13', '2022-10-15', '09:00:00', '12:00:00', 51, 98, 98, 1785);
...
--
ALTER TABLE `booking_accessory_table`
  MODIFY `booking_accessory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `booking_bike_table`
--
ALTER TABLE `booking_bike_table`
  MODIFY `booking_bike_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
