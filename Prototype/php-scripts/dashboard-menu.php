<?php
    ...
    function printMenu($activeClass="", $activeClassName="active")
    {
        ...
        echo "<a class='{$classes['inventory']}' href= 'Inventory.php'> <img src= 'img/icons/bicycle.png' alt='Inventory Logo' />  Inventory </a> <br>";
        echo "<a class='{$classes['accessory']}' href='Accessory.php'> <img src='img/icons/accessories.png' alt='Inventory Logo' /> Accessories </a> <br>";
