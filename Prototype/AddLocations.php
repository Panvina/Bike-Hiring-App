...
else if(!(substr($postcodeInput,-4,1)==3)){//To show this is from the state of victoria
...
else
{
	...
	`Drop Off Location` tinyint(1) NOT NULL DEFAULT 0,
	`Pick Up Location` tinyint(1) NOT NULL DEFAULT 0
	)";
