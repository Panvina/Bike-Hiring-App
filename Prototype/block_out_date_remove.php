...
// Block Out Date Unblock Function - Created by Eamon Kearney 102093549 //
...
<?php
    ...
    //Update sql statement to unblock date in database
    $sql = "UPDATE block_out_dates SET date_blockout = 0 WHERE date_id = $blockOutDate";
