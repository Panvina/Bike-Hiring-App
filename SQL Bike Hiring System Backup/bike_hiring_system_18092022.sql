...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2022 at 02:02 PM
...
(315, 'BikeTest', 55, 2, 40, 1, 'Description'),
...
('EM-AccountRoleTest', 'add', '0412345678', 'TestEmail@gmail.com', '2 test street', 'asdd', '1234', 'vic'),
...
(98, 'New location', 'asdadd', 'asdd', '3977', 1, 1);
...
--
ALTER TABLE `booking_accessory_table`
  MODIFY `booking_accessory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `booking_bike_table`
--
ALTER TABLE `booking_bike_table`
  MODIFY `booking_bike_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
